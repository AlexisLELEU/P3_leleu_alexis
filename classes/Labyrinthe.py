...
""" This module contain Labyrinthe class """

class Labyrinthe:
    """
    The labyrinth class allows the management of the whole labyrinth,
    movement, distribution of objects and operation of the game
    """
    ...
    def show_labyrinthe(self):
        """
        This method render the labyrinthe in pygame window
        """
